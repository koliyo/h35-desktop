...
from h35_ops.ghutil import DEFAULT_CHECKS, gh_run, wait_for_check
from h35_ops.paths import repo_root

PROMOTE_USAGE = "usage: h35-ops promote tag"
PROMOTE_TAG_USAGE = "usage: h35-ops promote tag <tag> [--from BRANCH]"
