...
if [[ -z $executable ]]; then
  ...
  executable=$(echo "$executable" | tr '[:upper:]' '[:lower:]')
fi
...
codesign --force --options runtime --timestamp --sign "$identity" "$app/Contents/MacOS/$executable"
